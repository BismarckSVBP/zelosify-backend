...
import vendorOpenings from "./routers/vendor/vendorOpeningsTestRoutes.js";
...
async function startServer() {
  try {
    ...
    app.use("/api/v1/vendor", vendorRoutes); //Actual vendor routes

    app.use("/api/test/vendor", vendorOpenings); //Test routes for vendor
